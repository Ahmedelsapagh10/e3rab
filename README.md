...
يبني Android محليًا بتوقيع التطوير عندما لا يوجد `android/key.properties`،
حتى يكون ملف APK قابلًا للتثبيت. إصدارات المتجر يجب أن تستخدم ملف
`key.properties` ومفتاح إصدار خاصًا لا يُضافان إلى المستودع.
...
- اسم حزمة Dart التاريخي `new_strucuture` لم يتغير، بينما يستخدم Android المعرّف `e3rab.elsapagh.net` وتطبيق Firebase مستقلًا له.
