  ...
  static String message(Object error) {
    ...
    return switch (error.code) {
      ...
      'operation-not-allowed' =>
        'طريقة تسجيل الدخول هذه غير مفعّلة حاليًا. استخدم البريد الإلكتروني.',
      'operation-not-supported' =>
        'استخدم البريد الإلكتروني لتسجيل الدخول على هذا الجهاز.',
      'sign-in-cancelled' => 'تم إلغاء تسجيل الدخول.',
      'account-exists-with-different-credential' =>
        'يوجد حساب بهذا البريد بطريقة دخول أخرى. استخدم الطريقة السابقة ثم اربط الحسابين.',
      'requires-recent-login' =>
        'يلزم تسجيل الدخول من جديد قبل تنفيذ هذا الإجراء الحساس.',
